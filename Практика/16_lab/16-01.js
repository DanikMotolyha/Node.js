...
{
   "query": "query { getSubjects(subject: 2) {SUBJECT_ID, SUBJECT_NAME} }"
}

{
   ...
   "variables":
   {
     "faculty":
     {
       "facultyName": "Факультет радиоэлектроники"
     }
   }
}
...
{
"query": "query { getTeachers(faculty:1) {TEACHER_ID, TEACHER_NAME} }"
}


{
"query": "query { getSubjects(faculty:1) {SUBJECT_ID, SUBJECT_NAME} }"
}
